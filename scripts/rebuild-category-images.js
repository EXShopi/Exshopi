...
const mappings = [
  { target: 'computer.webp', sourceNames: ['electronics', 'computeracessories', 'laptop', 'Laptop', 'Laptop.png', 'electronics.png'] },
  { target: 'tv.webp', sourceNames: ['Television', 'Television.png', 'television', 'television.png'] },
  { target: 'gaming.webp', sourceNames: ['Gamingpc', 'Gamingpc.png', 'gaming', 'gaming.png', path.join('Banners','gaming')] },
  { target: 'clothing.webp', sourceNames: ['women fashion', 'women fashion.png', 'manfashion', 'manfashion.png', 'best seller.png'] },
  { target: 'kitchen-appliances.webp', sourceNames: ['Homeappliances', 'Homeappliances.png', 'homeappliances', 'homeappliances.png'] },
  { target: 'projector.webp', sourceNames: ['electronics', 'Laptop', 'Laptop.png', 'electronics.png'] },
];

async function findSource(name) {
  // If name contains a path, resolve directly from public
