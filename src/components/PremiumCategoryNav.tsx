...
export default function PremiumCategoryNav() {
  ...
  return (
    <nav className="sticky top-[92px] z-[70] border-b border-slate-200/80 bg-white/96 backdrop-blur-2xl shadow-[0_10px_24px_rgba(15,23,42,0.06)] md:top-[96px]">
      <div className="mx-auto max-w-[1800px] px-4 py-2 md:px-6">
        <div className="flex items-center gap-2 overflow-x-auto py-1 no-scrollbar md:flex-wrap md:justify-center md:overflow-visible">
          ...
          >
            <button
              ...
              className={`group relative flex items-center gap-2 whitespace-nowrap rounded-full border border-[#d9efe7]/90 bg-[linear-gradient(135deg,rgba(232,255,246,0.92),rgba(241,255,246,0.86),rgba(255,255,255,0.78))] px-4 py-2.5 font-semibold tracking-tight text-[#27453d] shadow-[0_14px_28px_rgba(0,0,0,0.16)] backdrop-blur-xl transition-all duration-300 ${
                departmentsOpen
            ...
            >
              <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgba(232,255,246,1),rgba(218,247,232,0.96))] text-[#2d5a4e] shadow-inner">
          ...
          {[...mainNavItems.slice(1), ...extraNavItems].map((item: NavItem) => (
            <Link
              key={item.slug}
              to={item.route || "/"}
              className={`group relative flex items-center gap-2 whitespace-nowrap rounded-full border border-[#d9efe7]/90 bg-[linear-gradient(135deg,rgba(232,255,246,0.92),rgba(241,255,246,0.86),rgba(255,255,255,0.78))] px-4 py-2.5 font-semibold tracking-tight text-[#27453d] shadow-[0_14px_28px_rgba(0,0,0,0.16)] backdrop-blur-xl transition-all duration-200 ${
