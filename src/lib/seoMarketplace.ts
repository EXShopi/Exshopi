...
export function extractProductSeoFacts(product: any) {
...
export const LANDING_PAGES: LandingPageDefinition[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Buy iPhone in UAE with cleaner product listings, verified seller signals, COD-ready checkout, and marketplace links to related Apple and mobile deals on ExShopi.",
    ...
    intro:
      "This landing page targets high-intent iPhone shoppers in the UAE who are comparing model year, storage, condition, and delivery trust before placing an order online.",
    sections: [
      {
  ...
  },
  {
    ...
    metaDescription:
      "Shop refurbished laptops UAE with structured specifications, verified seller trust signals, and internal links to laptop and MacBook deals on ExShopi.",
    ...
    intro:
      "This page supports shoppers who want budget-friendly laptop options in the UAE without sacrificing specification clarity or seller trust.",
    sections: [
      {
  ...
  },
  {
    ...
    metaDescription:
      "Find cheap MacBook Dubai deals with structured product details, cleaner Apple laptop pages, and marketplace trust signals built for UAE search intent.",
    ...
    intro:
      "MacBook shoppers in Dubai often compare older Intel models, refreshed business stock, and refurbished units, so the listing quality matters almost as much as the price.",
    sections: [
      {
  ...
  },
  {
    ...
    metaDescription:
      "Browse electronics online UAE with category links, structured product pages, COD-ready checkout signals, and verified marketplace trust on ExShopi.",
    ...
    intro:
      "This page acts as a broad organic entry point for high-volume UAE electronics terms while pushing visitors deeper into categories, products, and buyer guidance.",
    sections: [
      {
